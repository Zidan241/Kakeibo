...
import 'package:kakeibo/widgets/dialog/account_form.dialog.dart';
import 'package:kakeibo/widgets/dialog/category_form.dialog.dart';
import 'package:kakeibo/widgets/buttons/button.dart';
import 'package:kakeibo/widgets/dialog/confirm.modal.dart';
...
class _PaymentForm extends State<PaymentForm> {
  ...
  Category? _category;
  double _amount = 0;
  PaymentType _type = PaymentType.debit;
